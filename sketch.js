...
function setup() {
	...
	ball1 = Bodies.circle(400,300,40,ball_options);
	World.add(world,ball1);
	ball2 = Bodies.circle(405,300,40,ball_options);
	World.add(world,ball2);
	ball3 = Bodies.circle(410,300,40,ball_options);
	World.add(world,ball3);
	ball4 = Bodies.circle(415,300,40,ball_options);
	World.add(world,ball4);
	ball5 = Bodies.circle(420,300,40,ball_options);
...
function keyPressed() {
	if (keyCode === UP_ARROW) {
		Matter.Body.applyForce(ball1,{x:0,y:0},{x:0,y:0.75});
	}
}